...
<div class="container">
	<div class="card">
		...
		<div class="card-content">
				<input type="radio" name="gioitinh" value="Anh">Anh
				<input type="radio" name="gioitinh" value="Chị">Chị
				<div class="card-content">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
						  		<label for="usr">Họ tên:</label>
						  		<input type="text" name="ten" placeholder="Nhập tên" class="form-control" id="usr">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
						  		<label for="usr">Số điện thoại:</label>
						  		<input type="text" name="sdt" placeholder="Nhập số điện thoại" class="form-control" id="usr">
							</div>
						</div>
					</div>
					<div class="form-group">
					  <label for="comment">Địa chỉ:</label>
					  <textarea class="form-control" name="diachi" placeholder="Nhập địa chỉ" rows="3" id="comment"></textarea>
					</div>
					<div class="form-group">
		...
		<div class="card-content">
		Tiền mặt: Quý khách thanh toán tiền mặt trực tiếp cho nhân viên giao hàng ngay sau khi nhận hàng.
		</div>
		<hr>
		<div class="card-content">
			<div class="row">
