...
@include('frontend.includes.menu')
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 100px; margin-left: -790px">
					    ...
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					        ...
					        <div class="form-group">
							  ...
							  <input type="text" class="form-control" name="ten" placeholder="Nhập tên thương hiệu">
							</div>
							<div class="form-group">
					      ...
					      <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-danger" data-dismiss="modal"><a href="{{ route('thuonghieu') }}">Trở về trang chủ</a></button>
					      </div>
					    </div>
					  </div>
            		</form>
